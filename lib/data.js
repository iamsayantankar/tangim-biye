...
export const couple = {
  groom: {
    ...
    siblings: [
      { relation: "Elder Brother", name: "Sk Ansar Ali" },
      { relation: "Elder Sister", name: "Azma Ara Khatun" },
    ],
    address: [
      "Mahutpara, Abash",
...
export const events = {
  haldi: {
    ...
    pretty: "13th Aug, 2026 (Thursday)",
    time: "7:00 PM onwards",
    note: "A night drenched in marigold & joy",
  },
  mehendi: {
    name: "Mehendi Ceremony",
    tagline: "Intricate henna, music & twirling colours",
    day: "Thursday",
    date: "13th August 2026",
    pretty: "13th Aug, 2026 (Thursday)",
    time: "9:00 PM onwards",
    note: "Adorned in henna, mehendi & happiness",
  },
  wedding: {
    name: "The Wedding",
